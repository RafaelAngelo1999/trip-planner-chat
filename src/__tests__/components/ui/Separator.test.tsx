...
describe("Separator Component", () => {
  ...
  describe("Acessibilidade", () => {
    ...
    it("deve ter data-orientation correto para vertical", () => {
      render(
        <Separator
          orientation="vertical"
          data-testid="vertical-orientation"
        />,
      );
  ...
  describe("Estilos e Aparência", () => {
    ...
    it("debe aceitar bordas decorativas", () => {
      render(
        <Separator
          className="h-0 border-t-2 border-dashed border-gray-300 bg-transparent"
