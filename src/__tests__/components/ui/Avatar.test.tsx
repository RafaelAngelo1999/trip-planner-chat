...
describe('Avatar Components', () => {
  ...
  describe('Acessibilidade', () => {
    ...
    it('deve ser focável quando necessário', () => {
      render(
        <Avatar tabIndex={0} data-testid="focusable-avatar">
          <AvatarFallback>FC</AvatarFallback>
        </Avatar>
      );

      expect(screen.getByTestId('focusable-avatar')).toHaveAttribute('tabIndex', '0');
    });
  });
  ...
  describe('Casos Extremos', () => {
    ...
    it('deve combinar múltiplas classes corretamente', () => {
      render(
        <Avatar className="border-2 border-blue-500 custom-avatar" data-testid="styled-avatar">
          <AvatarFallback className="bg-blue-100 text-blue-800">CB</AvatarFallback>
        </Avatar>
      );
      ...
      expect(avatar).toHaveClass('border-2', 'border-blue-500', 'custom-avatar');
